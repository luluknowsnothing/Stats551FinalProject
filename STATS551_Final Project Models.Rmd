...
steps_fix_1 <- c(0.01,0.01,0.005)
steps_fix_2 <- c(0.008, 0.008, 0.005)
steps_fix_3 <- c(0.005, 0.005, 0.004)

chain1_data1 = run_metropolis_MCMC(startvalue1, 50000, data1, n1, 2, steps_fix_1)
write.csv(chain1_data1, "chain1_data1.csv")
chain1_data1 <- NULL
chain2_data1 = run_metropolis_MCMC(startvalue1, 50000, data1, n1, 2, steps_fix_1)
write.csv(chain2_data1, "chain2_data1.csv")
chain2_data1 <- NULL
chain3_data1 = run_metropolis_MCMC(startvalue1, 50000, data1, n1, 2, steps_fix_1)
write.csv(chain3_data1, "chain3_data1.csv")
chain3_data1 <- NULL

chain1_data2  = run_metropolis_MCMC(startvalue2, 50000, data2, n2, 4, steps_fix_2)
write.csv(chain1_data2, "chain1_data2.csv")
chain1_data2 <- NULL
chain2_data2  = run_metropolis_MCMC(startvalue2, 50000, data2, n2, 4, steps_fix_2)
write.csv(chain2_data2, "chain2_data2.csv")
chain2_data2 <- NULL
chain3_data2  = run_metropolis_MCMC(startvalue2, 50000, data2, n2, 4, steps_fix_2)
write.csv(chain3_data2, "chain3_data2.csv")
chain3_data2 <- NULL

chain1_data3  = run_metropolis_MCMC(startvalue3, 50000, data3, n3, 4, steps_fix_3)
write.csv(chain1_data3, "chain1_data3.csv")
chain1_data3 <- NULL
chain2_data3  = run_metropolis_MCMC(startvalue3, 50000, data3, n3, 4, steps_fix_3)
write.csv(chain2_data3, "chain2_data3.csv")
chain2_data3 <- NULL
chain3_data3  = run_metropolis_MCMC(startvalue3, 50000, data3, n3, 4, steps_fix_3)
...
acceptance = 1-mean(duplicated(chain1_data2[-(1:burnIn),]))
```

```{r traceplot, warning=F}
ggplot() +
  geom_line(data = data.frame(x = 1:9001, y = chain1_data1[1001:10001, 3]), aes(x,y),
                     color = "red") +
  geom_line(data = data.frame(x = 1:9001, y = chain2_data1[1001:10001, 3]), aes(x,y),
                     color = "blue") +
  #geom_line(data = data.frame(x = 1:niters, y = chain3_ts[,5]), aes(x,y),
                    # color = "green") +
  xlab("Iterations") + ylab("p") + ggtitle("Trace plot for p") + theme_bw()

```



### Model theta on Baseline
```{r}
# Multilevel Model
# Linear model: 
# Level 1: Others(pi) = baseline(p) + beta(p)*Self(pi) + N(0,sdb(p)^2) 
