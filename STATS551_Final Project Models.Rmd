...
chain1_data1 = run_metropolis_MCMC(startvalue1, 10000, data1, n1, 2, steps_fix_1)
chain2_data1 = run_metropolis_MCMC(startvalue1, 10000, data1, n1, 2, steps_fix_1)
chain3_data1 = run_metropolis_MCMC(startvalue1, 50000, data1, n1, 2)

chain1_data2  = run_metropolis_MCMC(startvalue2, 10000, data2, n2, 4, steps_fix_2)
chain2_data2  = run_metropolis_MCMC(startvalue2, 50000, data2, n2, 4)
chain3_data2  = run_metropolis_MCMC(startvalue2, 50000, data2, n2, 4)
...
acceptance = 1-mean(duplicated(chain1_data1[-(1:burnIn),]))
```
