...
=======
          ...
          print(theta_pro) 
          print(sd_pro)
          print(post(x, y, base_pro, alpha, beta, theta_pro, sd_pro, option))
          print(post(x, y, chain[i,1], alpha, beta, chain[i,2], chain[i,3], option))
>>>>>>> 1f8ec392cfbda2b527008317f1798b4caa01cf2d
        }
        if (runif(1) < probab){
            chain[i+1,] <- proposal
        }else{
